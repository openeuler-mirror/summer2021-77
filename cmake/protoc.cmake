...
set(CHECKPOINT_PROTOS_OUT_PATH ${GRPC_OUT_PRE_PATH}/src/api/services/checkpoints)
...
if (GRPC_CONNECTOR)
    ...
    execute_process(COMMAND mkdir -p ${CHECKPOINT_PROTOS_OUT_PATH})
    ...
    execute_process(COMMAND ${CMD_PROTOC} -I ${PROTOS_PATH}/checkpoints --cpp_out=${CHECKPOINT_PROTOS_OUT_PATH} ${PROTOS_PATH}/checkpoints/checkpoints.proto ERROR_VARIABLE checkpoints_err)
    if (checkpoints_err)
        message("Parse checkpoints.proto failed: ")
        message(FATAL_ERROR ${checkpoints_err})
    endif()

    execute_process(COMMAND ${CMD_PROTOC} -I ${PROTOS_PATH}/checkpoints --grpc_out=${CHECKPOINT_PROTOS_OUT_PATH} --plugin=protoc-gen-grpc=${CMD_GRPC_CPP_PLUGIN} ${PROTOS_PATH}/checkpoints/checkpoints.proto ERROR_VARIABLE checkpoints_err)
    if (checkpoints_err)
        message("Parse checkpoints.proto plugin failed: ")
        message(FATAL_ERROR ${checkpoints_err})
    endif()
